...
} from "@/app/_lib/database/supplier_data";
              ...
              <Flex
                ...
                {IsAdmin && (
                  <Button
                    mr="2"
                    onClick={() => (
                      setisTable(true), setType("Create"), setcodigo("")
                    )}
                    colorScheme="teal"
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 transition-opacity duration-300">
                  <div className="bg-white p-4 w-5/6 max-w-md border text-center border-gray-300 rounded-3xl shadow-md relative z-20 ">
                    ...
                    <VStack
                      ...
                      mt={5}>
                      <Text>
                        La razon del rechazo se debe a una inconsistencia en el
                        apartado del numero de la factura y en el peso total ya
                        que no estan acordes en ninguna factura existente
                      </Text>
                    </VStack>
