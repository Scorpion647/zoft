        ...
        <ChakraProvider>
            <div  className="w-full flex items-center justify-center lg:w-1/2 bg-gradient-to-tr from-green-900 to-green-700 ">
                <Box className='bg-gradient-to-tr border-2 border-black from-gray-200 to-gray-300 px-10 py-20 rounded-3xl'>
                    <VStack>
                        <Heading mb="2" h={10} color='black' style={{ fontSize: '200%' }} noOfLines={1}>Registro</Heading>
                        ...
                        <VStack spacing="0px">
                            ...
                            <HStack >
                                ...
                                <Text cursor="pointer" onClick={() => { setFormType(FormType.Login) }} fontSize='sm' color='blue'>aqui</Text>
                            </HStack>
                        </VStack>
                    </VStack>
                </Box>
