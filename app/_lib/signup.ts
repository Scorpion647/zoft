...
export async function signup(formData: FormData) {
    ...
    const confirmPasswordError = validateAndConfirmPassword(password, confirmPassword);
...
async function createUser(email: string, username: string, password: string): Promise<void | CustomDataError> {
