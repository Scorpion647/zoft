...
import { CustomDataError, AccessDataFields, manageErrorMessage } from '@/app/_lib/definitions';
import { createClient } from '@/app/_lib/supabase/server'
import { validatePassword } from '@/app/_lib/utils/accessFieldsValidations';

export async function login(formData: FormData): Promise<void | CustomDataError> {
