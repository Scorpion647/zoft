...
export function validateAndConfirmPassword(password: string, confirmPassword: string): void | CustomDataError {
    if (password) {
...
export function validatePassword(password: string, field: AccessDataFields): void | CustomDataError {
