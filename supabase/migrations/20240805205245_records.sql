...
CREATE TABLE IF NOT EXISTS Public.Record (
  ...
  PRIMARY KEY ( id ),
  FOREIGN KEY ( material_code ) REFERENCES Public.Material ( Code ) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO Access.Table_Permission (Table_Name, User_Role, Permissions)
VALUES ('record_info', 'employee', '0010');
...
CREATE POLICY "Insert policy" ON Public.Record_Info FOR INSERT WITH CHECK ( public.can_access_record_info( id, B'0010' ) );
